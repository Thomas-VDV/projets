...
public class StatusBar {
    //Classe gérant la barre de statut du jeu
    ...
    public void update() {
        ...
        lives.setText(""+player.getNbLives()+"");
        bombRange.setText(""+player.getRangeBomb()+"");
        availableBombs.setText(""+player.getNbBomb()+"");
        keys.setText(""+player.getCle()+"");
        level.getChildren().clear();
        level.getChildren().add(new ImageView(ImageResourceFactory.digit(game.level()+1).getImage()));
    }
}
