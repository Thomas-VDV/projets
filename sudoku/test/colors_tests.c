...
int main (void) {
  ...
  EXPECT ((colors_full (36) == 68719476735),
          "colors_full(36) == [0,1, ... ,35]");
  ...
  EXPECT ((colors_set (63) == 9223372036854775808ULL),
          "colors_set(63) == [63]");
  ...
  EXPECT (
      (colors_add (colors_add (colors_set (4), 27), 41) == 2199157473296ULL),
  ...
  EXPECT ((colors_add (colors_add (colors_set (4), 63), 41) ==
           9223374235878031376ULL),
  ...
  EXPECT (
      (colors_add (colors_add (colors_set (4), 47), 79) == 140737488355344ULL),
  ...
  EXPECT (
      (colors_subtract (colors_empty (), colors_empty ()) == colors_empty ()),
      "colors_subtract([], []) == []");
  ...
  EXPECT (
      (colors_count (colors_add (colors_add (colors_set (4), 27), 41)) == 3),
  ...
  EXPECT (
      (colors_rightmost (colors_add (colors_set (0), 63)) == colors_set (0)),
  ...
  EXPECT (
      (colors_leftmost (colors_add (colors_set (0), 63)) == colors_set (63)),
